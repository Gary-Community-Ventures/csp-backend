...
# Onboard Provider Script
# Usage: ./scripts/onboard_provider.sh <environment> <clerk_user_id> <provider_id>
# Example: ./scripts/onboard_provider.sh "dev" "user_2xyz789abc123" "15"
...
if [ $# -lt 3 ]; then
    echo "Usage: $0 <environment> <clerk_user_id> <provider_id>"
    echo "Environments: dev, staging, prod"
    echo "Example: $0 'dev' 'user_2xyz789abc123' '15'"
    exit 1
fi
...
curl -X POST "$BASE_URL/provider/onboard" \
