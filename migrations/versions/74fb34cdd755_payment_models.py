...
def upgrade():
    ...
    with op.batch_alter_table("family_payment_settings", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_family_payment_settings_family_external_id"), ["family_external_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["family_payment_settings_id"], ["family_payment_settings.id"], name="fk_payment_family_settings_id"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["family_payment_settings_id"], ["family_payment_settings.id"], name="fk_payment_intent_family_settings_id"
        ),
        sa.ForeignKeyConstraint(
    ...
    with op.batch_alter_table("payment_attempt", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_payment_attempt_family_chek_user_id"), ["family_chek_user_id"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_payment_attempt_id"), ["id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_payment_attempt_provider_chek_card_id"), ["provider_chek_card_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_payment_attempt_provider_chek_direct_pay_id"), ["provider_chek_direct_pay_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_payment_attempt_provider_chek_user_id"), ["provider_chek_user_id"], unique=False
        )
