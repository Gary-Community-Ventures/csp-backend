...
class ProviderOnboarding(BaseOnboarding):
    ...
    def get_existing_settings(self, external_id: str) -> Optional[ProviderPaymentSettings]:
        return ProviderPaymentSettings.query.filter_by(
    ...
    def extract_entity_fields(self, entity_data: Dict) -> Dict:
        return {
            ...
            'address_line1': entity_data.get(ProviderColumnNames.ADDRESS_LINE1),
            'address_line2': entity_data.get(ProviderColumnNames.ADDRESS_LINE2),
