...
def list_failed_payments(since_date=None):
    ...
    for payment in failed_payments:
        ...
        last_attempt = PaymentAttempt.query.filter_by(
...
def main():
    ...
    parser.add_argument(
        "--payment-id",
        type=str,
        help="UUID of specific payment to retry"
    )
    parser.add_argument(
        "--all",
        action="store_true",
        help="Retry all failed payments"
    )
    parser.add_argument(
        "--since",
        type=str,
        help="Retry failures since date (YYYY-MM-DD)"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
